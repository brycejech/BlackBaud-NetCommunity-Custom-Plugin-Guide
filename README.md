...
![Creating an Empty Web Application in Visual Studio](https://github.com/brycejech/BlackBaud-NetCommunity-Custom-Plugin-Guide/screenshots/CreateEmptyWebApplication.jpg?raw=true)
